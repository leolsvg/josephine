...
import { isDateOpen, timesGroupsForDate } from "@/feat/booking/utils/schedule";
import { useTRPC } from "@/lib/trpc/react";
import { bookingFormOptions } from "../../hooks/use-booking-form";
import { useSchedule } from "./use-schedule";

export const BookingUserForm = withForm({
  ...bookingFormOptions,
  render: ({ form }) => {
    return (
      <>
...
export const BookingDateForm = withForm({
  ...bookingFormOptions,
  render: ({ form }) => {
...
export const BookingBaseForm = withForm({
  ...bookingFormOptions,
  render: ({ form }) => {
    const trpc = useTRPC();
