...
export const SBooking = z.object({
  ...
  // date: z.custom<Temporal.PlainDate>((data) => {
  //   console.log(data);
  //   return data instanceof Temporal.PlainDate;
  // }),
  // time: z.custom<Temporal.PlainTime>((data) => {
  //   console.log(data);
  //   return data instanceof Temporal.PlainTime;
  // }),
