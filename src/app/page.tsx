...
export default function Home() {
  return (
    <div>
      ...
      {/* IMAGE DE FOND + SECTION D'ACCUEIL */}
      <div
        ...
        <section id="fournisseurs" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="flex justify-center text-center">
              ...
              partenaires.
              <br />
              Nous travaillons main dans la main avec des producteurs et
              artisans <br />
              locaux passionnés, qui partagent nos valeurs de fraîcheur, de
              saisonnalité et de respect du produit. <br /> Découvrez ceux qui
              nous permettent chaque jour de vous proposer une cuisine sincère
              et savoureuse.
            </p>
